...
export class ProjectView extends Component {
  ...
  sendMessage() {
    ...
    const msgData = {
      sender: globalStore.data.user.name,
  ...
  renderKanban() {
    ...
    return this.createElement(
      ...
      new Card({
        title: 'Add New Task',
        children: [
          new Input({ placeholder: 'Task title...', value: this.state.newTaskTitle, onInput: e => this.setState({ newTaskTitle: e.target.value }) }),
  ...
  renderChat() {
    return this.createElement(
      ...
      this.createElement(
        ...
        new Input({ placeholder: 'Type real-time message...', value: this.state.chatInput, onInput: e => this.setState({ chatInput: e.target.value }) }),
  ...
  render() {
    ...
    return this.createElement(
      ...
      this.state.activeTab === 'kanban' ? this.renderKanban() : null,
      this.state.activeTab === 'editor' ? new CodeEditor({}).render() : null,
      this.state.activeTab === 'chat' ? this.renderChat() : null
    );
  }
}